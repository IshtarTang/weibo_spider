...
2021.8.11  是这样，为了写简历我给这个程序写了个scrapy框架版本的，链接是这个 [weibo_spider-scrapy](https://github.com/IshtarTang/weibo_spider-scrapy)， 以后想整啥功能都在scrapy版本的里了，这个程序就 没有后续更新了，具体为啥写在更新记录里面。
...
download_img：如果要保存微博里的图片，在主程序运行完后把这个放到结果文件夹里运行 
...
登录状态信息，没有这个只能获取到一页内容，也获取不到设置了分享范围（粉丝可见/好友圈/仅自己可见）的微博
...
![1612685868249](笔记图/简述/1612685868249.png)
